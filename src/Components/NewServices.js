...
import igf from '../Asstes/igf.png';
import ghr from '../Asstes/ghr.png';
import nefof from '../Asstes/nefof.png';
// import hksre from '../Asstes/hksre.png';
import styled from 'styled-components';
const SerStyle = styled.div`
body {
    width: 100%;
    min-height: 100vh;
        ...
        <SerStyle>
            ...
            <div className="pset">
                <div className="container">
                  ...
                  <p className='text-center'>As your tax return specialists, we offer various services</p>
                                    ...
                                    <div className="listar-feature-block-content-wrapper">
                                        <div className="listar-feature-icon-wrapper">
                                            <div className="listar-feature-icon-inner">
                                                <div>
                                                    <img alt="Services" className="listar-image-icon"
                                                        src={igf}  />
                                                </div>
                                            </div>
                                        </div> 
                                ...
                                <div className="listar-feature-item-inner">
                                    ...
                                    <div className="listar-feature-block-content-wrapper">
                                        <div className="listar-feature-icon-wrapper">
                                            <div className="listar-feature-icon-inner">
                                                <div>
                                                    <img alt="Customers" className="listar-image-icon" src={ghr}/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="listar-feature-content-wrapper" style={{ paddingTop: "0px" }}>
                                            ...
                                            <div className="listar-feature-item-excerpt">
                                            Reducing taxable income, whether it is the result of compensation or inheritance.</div>
                                ...
                                <div className="listar-feature-item-inner">
                                    ...
                                    <div className="listar-feature-block-content-wrapper">
                                        <div className="listar-feature-icon-wrapper">
                                            <div className="listar-feature-icon-inner">
                                                <div>
                                                    <img alt="Feedback" className="listar-image-icon" src={nefof} />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="listar-feature-content-wrapper" style={{ paddingTop: "0px" }}>
                                            ...
                                            <div className="listar-feature-item-title listar-feature-counter-added">
                                                <span><span>03</span>
                                                Business Tax Services</span>
                                            </div>

                                            <div className="listar-feature-item-excerpt">
                                            Large or small, established or startup, the same goal
                                for all - save you tax money.</div>
